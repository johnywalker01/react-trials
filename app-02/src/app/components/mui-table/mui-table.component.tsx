...
import { getTimeSinceEpochUTC } from 'app/api/common';
...
export const MuiTable: React.FC<FcProps> = ( props ) => {
    const [rows, setRows] = React.useState( [
        createData( getTimeSinceEpochUTC( true ).toString(), '', '', true ),
    ] );

    const handleCreateRow = () => {
        const replica = clone( rows );
    ...
    const handleTextChange = ( event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>,
        columnType: string, rowID: string ) => {
    ...
    return (
        ...
        //                     <TableCell align="center">{ row.deleteable ? 'del' : 'NA' }</TableCell>
        //                 </TableRow>
        //             ) ) }
        //         </TableBody>
        //     </Table>
                        ...
                        >
                            ...
                            <TableCell >
                                <TextField variant='standard' size="small"
                                    value={ row.name } onChange={ ( e ) => handleTextChange( e, 'name', row.id ) } />
                            </TableCell>
                            <TableCell >
                                <TextField variant='standard' size="small"
                                    value={ row.value } onChange={ ( e ) => handleTextChange( e, 'value', row.id ) } />
                            </TableCell>
                            <TableCell align="center">{ row.deleteable ?
